...
const OLYMPIC_DESCRIPTION =
  "קייטנת חוויה אולימפית מתקיימת במרכז הספורט העירוני גלי חיפה ברחוב צביה ויצחק 1.\nהקייטנה מיועדת לילדים העולים לכיתות א׳-ח׳. הקייטנה משלבת ספורט, יצירה, משחקים, בריכה והפעלות באווירה בטוחה ונעימה.\nבכל יום הילדים עוברים בין חמש תחנות פעילות מתחלפות: ספורט ותנועה, יצירה והפעלות, ארוחת בוקר, חוגים לבחירה כמו כדורגל, טניס, ריקוד ושחייה (במידה ואתם בוחרים בקייטנה חוויה אולימפית) וזמן בריכה רדודה בליווי מציל וצוות מקצועי.\nהפעילות מחולקת לקבוצות גיל, עם צוות הדרכה שעבר הכשרה ומתאים לעבודה עם ילדים, כדי שכל ילד יוכל להשתלב בקצב שלו, ליהנות מהחברים ומהפעילות ולהרגיש שיש מי שרואה אותו לאורך היום.\nלמשפחות שצריכות יום ארוך קיימת אפשרות לצהרון עד 16:00, כולל ארוחת צהריים חמה והמשך פעילות רגועה ומהנה עד האיסוף.";
